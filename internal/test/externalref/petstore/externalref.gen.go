...
type FindPetsByStatusParams struct {
	...
	Status *FindPetsByStatusParamsStatus `form:"status,omitempty" json:"status,omitempty" query:"status,omitempty"`
}
...
type UpdatePetWithFormParams struct {
	...
	Name *string `form:"name,omitempty" json:"name,omitempty" query:"name,omitempty"`

	// Status Status of pet that needs to be updated
	Status *string `form:"status,omitempty" json:"status,omitempty" query:"status,omitempty"`
}

// UploadFileParams defines parameters for UploadFile.
type UploadFileParams struct {
	// AdditionalMetadata Additional Metadata
	AdditionalMetadata *string `form:"additionalMetadata,omitempty" json:"additionalMetadata,omitempty" query:"additionalMetadata,omitempty"`
}
...
type LoginUserParams struct {
	...
	Username *string `form:"username,omitempty" json:"username,omitempty" query:"username,omitempty"`

	// Password The password for login in clear text
	Password *string `form:"password,omitempty" json:"password,omitempty" query:"password,omitempty"`
}
