...
type GetWithArgsParams struct {
	...
	OptionalArgument *int64 `form:"optional_argument,omitempty" json:"optional_argument,omitempty" query:"optional_argument,omitempty"`

	// RequiredArgument An optional query argument
	RequiredArgument int64 `form:"required_argument" json:"required_argument" query:"required_argument"`
...
type CreateResource2Params struct {
	...
	InlineQueryArgument *int `form:"inline_query_argument,omitempty" json:"inline_query_argument,omitempty" query:"inline_query_argument,omitempty"`
}
